                ...
                <div class="more">
                    <?php
                        if ($Count > 10)
                        {
                            if ($Count <= 20) 
                                if ($Current == 0) { ?>
                                    <a href="moreposts?Limit=0" class="color-2">1</a>
                                    <a href="moreposts?Limit=1" class="color-1">2</a>
                                <?php }
                                else { ?>
                                    <a href="moreposts?Limit=0" class="color-1">1</a>
                                    <a href="moreposts?Limit=1" class="color-2">2</a>
                                <?php }
                            if ($Count > 20 && $Count <= 30){ 
                                if ($Current == 0) { ?>
                                    <a href="moreposts?Limit=0" class="color-2">1</a>
                                    <a href="moreposts?Limit=1" class="color-1">2</a>
                                    <a href="moreposts?Limit=2" class="color-1">3</a>
                                <?php }
                                else if ($Current == 1) { ?>
                                    <a href="moreposts?Limit=0" class="color-1">1</a>
                                    <a href="moreposts?Limit=1" class="color-2">2</a>
                                ...
                                <?php }
                                    ...
                                    <a href="moreposts?Limit=0" class="color-1">1</a>
                                    <a href="moreposts?Limit=1" class="color-1">2</a>
                                    <a href="moreposts?Limit=2" class="color-2">3</a>
                                <?php }
                            }
                            if ($Count > 30){
                                if ($Count <= 40 && $Current == 3){ ?>
                                    <a href="moreposts?Limit=0" class="color-1">&#10092;&#10092;</a>
                                    <a href="moreposts?Limit=1" class="color-1">2</a>
                                    <a href="moreposts?Limit=2" class="color-2">3</a>
                                    <a href="moreposts?Limit=3" class="color-1">4</a>
                                <?php }
                                ...
                                <?php }
                                    ...
                                    <a href="moreposts?Limit=1" class="color-1">2</a>
                                    <a href="moreposts?Limit=2" class="color-1">3</a>
                                    <a href="moreposts?Limit=3" class="color-2">4</a>
                                <?php }
                                else if ( (intval($Current)+1)*10 < $Count && $Count < (intval($Current)+2)*10 ) { ?>
                                    <a href="moreposts?Limit=<?= $Current - 2 ?>" class="color-1">&#10092;&#10092;</a>
                                    <a href="moreposts?Limit=<?= $Current - 1 ?>" class="color-1"><?= $Current - 1 ?></a>
                                    <a href="moreposts?Limit=<?= $Current ?>" class="color-2"><?= $Current ?></a>
                                    <a href="moreposts?Limit=<?= $Current + 1 ?>" class="color-1"><?= $Current + 1 ?></a>
                                <?php }
                                else if ((intval($Current)+1)*10 > $Count){ ?>
                                    <a href="moreposts?Limit=<?= $Current - 3 ?>" class="color-1">&#10092;&#10092;</a>
                                    <a href="moreposts?Limit=<?= $Current - 2 ?>" class="color-1"><?= $Current - 2 ?></a>
                                    <a href="moreposts?Limit=<?= $Current - 1 ?>" class="color-1"><?= $Current - 1 ?></a>
                                    <a href="moreposts?Limit=<?= $Current ?>" class="color-2"><?= $Current ?></a>
                                <?php }
                                else { ?>
